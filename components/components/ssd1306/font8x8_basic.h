...
// static uint8_t font8x8_basic_tr[128][6] = {
//     { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   // U+0000 (nul)
//     { 0x00, 0x0C, 0x0A, 0x3F, 0x0A, 0x0C },   // U+0001 (Up Allow)
//     { 0x00, 0x18, 0x30, 0x3F, 0x30, 0x18 },   // U+0002 (Down Allow)
...
//     { 0x00, 0x00, 0x00, 0x4F, 0x00, 0x00 },   // U+0021 (!)
//     { 0x00, 0x00, 0x07, 0x00, 0x07, 0x00 },   // U+0022 (")
//     { 0x00, 0x14, 0x7F, 0x14, 0x7F, 0x14 },   // U+0023 (#)
//     { 0x00, 0x24, 0x2A, 0x7F, 0x2A, 0x12 },   // U+0024 ($)
//     { 0x00, 0x23, 0x13, 0x08, 0x64, 0x62 },   // U+0025 (%)
//     { 0x00, 0x36, 0x49, 0x55, 0x22, 0x50 },   // U+0026 (&)
//     { 0x00, 0x00, 0x05, 0x03, 0x00, 0x00 },   // U+0027 (')
//     { 0x00, 0x00, 0x1C, 0x22, 0x41, 0x00 },   // U+0028 (()
//     { 0x00, 0x00, 0x41, 0x22, 0x1C, 0x00 },   // U+0029 ())
//     { 0x00, 0x08, 0x2A, 0x1C, 0x2A, 0x08 },   // U+002A (*)
//     { 0x00, 0x08, 0x08, 0x3E, 0x08, 0x08 },   // U+002B (+)
//     { 0x00, 0x00, 0x50, 0x30, 0x00, 0x00 },   // U+002C (,)
//     { 0x00, 0x08, 0x08, 0x08, 0x08, 0x08 },   // U+002D (-)
//     { 0x00, 0x00, 0x60, 0x60, 0x00, 0x00 },   // U+002E (.)
//     { 0x00, 0x20, 0x10, 0x08, 0x04, 0x02 },   // U+002F (/)
//     { 0x00, 0x3E, 0x51, 0x49, 0x45, 0x3E },   // U+0030 (0)
//     { 0x00, 0x00, 0x42, 0x7F, 0x40, 0x00 },   // U+0031 (1)
//     { 0x00, 0x42, 0x61, 0x51, 0x49, 0x46 },   // U+0032 (2)
//     { 0x00, 0x21, 0x41, 0x45, 0x4B, 0x31 },   // U+0033 (3)
//     { 0x00, 0x18, 0x14, 0x12, 0x7F, 0x10 },   // U+0034 (4)
//     { 0x00, 0x27, 0x45, 0x45, 0x45, 0x39 },   // U+0035 (5)
//     { 0x00, 0x3C, 0x4A, 0x49, 0x49, 0x30 },   // U+0036 (6)
//     { 0x00, 0x01, 0x71, 0x09, 0x05, 0x03 },   // U+0037 (7)
//     { 0x00, 0x36, 0x49, 0x49, 0x49, 0x36 },   // U+0038 (8)
//     { 0x00, 0x06, 0x49, 0x49, 0x29, 0x1E },   // U+0039 (9)
//     { 0x00, 0x00, 0x36, 0x36, 0x00, 0x00 },   // U+003A (:)
//     { 0x00, 0x00, 0x56, 0x36, 0x00, 0x00 },   // U+003B (/*)
//     { 0x00, 0x08, 0x14, 0x22, 0x41, 0x00 },   // U+003C (<)
//     { 0x00, 0x14, 0x14, 0x14, 0x14, 0x14 },   // U+003D (=)
//     { 0x00, 0x00, 0x41, 0x22, 0x14, 0x08 },   // U+003E (>)
//     { 0x00, 0x02, 0x01, 0x51, 0x09, 0x06 },   // U+003F (?)
//     { 0x00, 0x32, 0x49, 0x79, 0x41, 0x3E },   // U+0040 (@)
//     { 0x00, 0x7C, 0x12, 0x11, 0x12, 0x7C },   // U+0041 (A)
//     { 0x0E, 0x1F, 0x15, 0x15, 0x1F, 0x0E },   // U+0042 (B)
//     { 0x1C, 0x3E, 0x63, 0x41, 0x41, 0x22 }, // U+0043 (C)
//     { 0x0E, 0x1F, 0x11, 0x11, 0x1F, 0x0E }, // U+0044 (D)
//     { 0x0E, 0x1F, 0x15, 0x15, 0x11, 0x01 },// U+0045 (E)
//     { 0x0E, 0x1F, 0x05, 0x05, 0x01, 0x03 },// U+0046 (F)
//     { 0x1C, 0x3E, 0x63, 0x41, 0x55, 0x36 },// U+0047 (G)
//     { 0x1F, 0x1F, 0x04, 0x04, 0x1F, 0x1F },// U+0048 (H)
//     { 0x00, 0x11, 0x1F, 0x1F, 0x11, 0x00 },// U+0049 (I)
//     { 0x30, 0x70, 0x40, 0x41, 0x7F, 0x3F },// U+004A (J)
//     { 0x1F, 0x1F, 0x04, 0x0E, 0x1B, 0x11 },// U+004B (K)
//     { 0x1F, 0x1F, 0x10, 0x10, 0x10, 0x00 },// U+004C (L)
//     { 0x1F, 0x1F, 0x02, 0x02, 0x1F, 0x1F },// U+004D (M)
//     { 0x1F, 0x1F, 0x02, 0x04, 0x1F, 0x1F },// U+004E (N)
//     { 0x0E, 0x1F, 0x11, 0x11, 0x1F, 0x0E },// U+004F (O)
//     { 0x0F, 0x1F, 0x15, 0x05, 0x07, 0x02 },// U+0050 (P)
//     { 0x1C, 0x3E, 0x21, 0x71, 0x5F, 0x4E },// U+0051 (Q)
//     { 0x0F, 0x1F, 0x15, 0x0D, 0x17, 0x10 },// U+0052 (R)
//     { 0x09, 0x17, 0x15, 0x15, 0x1D, 0x09 },// U+0053 (S)
//     { 0x03, 0x01, 0x1F, 0x1F, 0x01, 0x03 },// U+0054 (T)
//     { 0x1F, 0x1F, 0x10, 0x10, 0x1F, 0x1F },// U+0055 (U)
//     { 0x0F, 0x1F, 0x10, 0x0C, 0x10, 0x1F },// U+0056 (V)
//     { 0x1F, 0x1F, 0x08, 0x04, 0x08, 0x1F },// U+0057 (W)
//     { 0x17, 0x1D, 0x0E, 0x0E, 0x1D, 0x17 },// U+0058 (X)
//     { 0x07, 0x0F, 0x1D, 0x18, 0x1C, 0x0E },// U+0059 (Y)
//     { 0x11, 0x19, 0x15, 0x13, 0x11, 0x00 },// U+005A (Z)
//     { 0x00, 0x1F, 0x1F, 0x11, 0x11, 0x00 },// U+005B ([)
//     { 0x00, 0x00, 0x01, 0x03, 0x06, 0x0C },// U+005C (\)
//     { 0x00, 0x11, 0x11, 0x1F, 0x1F, 0x00 },// U+005D (])
//     { 0x04, 0x06, 0x03, 0x03, 0x06, 0x04 },// U+005E (^)
//     { 0x10, 0x10, 0x08, 0x08, 0x04, 0x00 },// U+005F (_)
//     { 0x00, 0x01, 0x03, 0x02, 0x00, 0x00 },// U+0060 (`)
//     { 0x20, 0x54, 0x54, 0x3C, 0x40, 0x00 },   // U+0061 (a)
//     { 0x41, 0x3F, 0x48, 0x48, 0x30, 0x00 },   // U+0062 (b)
//     { 0x38, 0x44, 0x44, 0x6C, 0x00, 0x00 },   // U+0063 (c)
//     { 0x30, 0x48, 0x49, 0x3F, 0x40, 0x00 },   // U+0064 (d)
//     { 0x38, 0x54, 0x54, 0x5C, 0x00, 0x00 },   // U+0065 (e)
//     { 0x48, 0x7F, 0x49, 0x03, 0x00, 0x00 },   // U+0066 (f)
//     { 0x98, 0xA4, 0xA4, 0xF8, 0x04, 0x00 },   // U+0067 (g)
//     { 0x41, 0x7F, 0x08, 0x04, 0x78, 0x00 },   // U+0068 (h)
//     { 0x00, 0x44, 0x7D, 0x40, 0x00, 0x00 },   // U+0069 (i)
//     { 0x60, 0x80, 0x80, 0xFD, 0x00, 0x00 },   // U+006A (j)
//     { 0x41, 0x7F, 0x10, 0x38, 0x44, 0x00 },   // U+006B (k)
//     { 0x00, 0x41, 0x7F, 0x40, 0x00, 0x00 },   // U+006C (l)
//     { 0x7C, 0x18, 0x38, 0x1C, 0x78, 0x00 },   // U+006D (m)
//     { 0x7C, 0x04, 0x04, 0x7C, 0x00, 0x00 },   // U+006E (n)
//     { 0x38, 0x44, 0x44, 0x7C, 0x00, 0x00 },   // U+006F (o)
//     { 0x84, 0xF8, 0xA4, 0x24, 0x18, 0x00 },   // U+0070 (p)
//     { 0x18, 0x24, 0xA4, 0xF8, 0x84, 0x00 },   // U+0071 (q)
//     { 0x44, 0x78, 0x4C, 0x04, 0x18, 0x00 },   // U+0072 (r)
//     { 0x48, 0x54, 0x54, 0x74, 0x00, 0x00 },   // U+0073 (s)
//     { 0x00, 0x3E, 0x7F, 0x44, 0x00, 0x00 },   // U+0074 (t)
//     { 0x3C, 0x40, 0x40, 0x3C, 0x40, 0x00 },   // U+0075 (u)
//     { 0x1C, 0x60, 0x60, 0x3C, 0x00, 0x00 },   // U+0076 (v)
//     { 0x3C, 0x70, 0x38, 0x70, 0x3C, 0x00 },   // U+0077 (w)
//     { 0x44, 0x38, 0x10, 0x38, 0x44, 0x00 },   // U+0078 (x)
//     { 0x9C, 0xA0, 0xA0, 0xFC, 0x00, 0x00 },   // U+0079 (y)
//     { 0x4C, 0x74, 0x5C, 0x4C, 0x00, 0x00 },   // U+007A (z)
//     { 0x08, 0x3E, 0x77, 0x41, 0x00, 0x00 },   // U+007B ({)
//     { 0x00, 0x77, 0x77, 0x00, 0x00, 0x00 },   // U+007C (|)
//     { 0x41, 0x77, 0x3E, 0x08, 0x00, 0x00 },   // U+007D (})
//     { 0x02, 0x01, 0x03, 0x02, 0x01, 0x00 },   // U+007E (~)
